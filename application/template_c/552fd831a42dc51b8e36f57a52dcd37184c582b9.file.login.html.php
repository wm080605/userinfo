...
<?php /*%%SmartyHeaderCode:156202062556e9085379a527-56004850%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '156202062556e9085379a527-56004850',
  'function' => 
  array (
  ),
...
<?php if (isset($_smarty_tpl->getVariable('message',null,true,false)->value)&&$_smarty_tpl->getVariable('message')->value=="error_activation"){?>
    <div id="message" style="display: none;">用户不能登陆，请先激活邮箱</div>
<?php }elseif(isset($_smarty_tpl->getVariable('message',null,true,false)->value)&&$_smarty_tpl->getVariable('message')->value=="error_user_or_password"){?>   
    <div id="message" style="display: none;">密码错误或用户名不正确</div>
