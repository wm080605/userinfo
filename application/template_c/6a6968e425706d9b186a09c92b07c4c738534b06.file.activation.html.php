<?php /* Smarty version Smarty-3.0.6, created on 2016-03-17 14:02:34
         compiled from "/var/workspace/userinfo/application/views/client/user/activation.html" */ ?>
<?php /*%%SmartyHeaderCode:10369663656ea487aeb6281-60833709%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '10369663656ea487aeb6281-60833709',
  'function' => 
  array (
  ),
...
<?php echo form_open('/client/user/again_activation','class="form-signin" id="login"');?>
    ...
    <input name="email" type="text" class="form-control" id="email" placeholder="Email" value="<?php echo set_value('password');?>
">
...
<?php }elseif(isset($_smarty_tpl->getVariable('message',null,true,false)->value)&&$_smarty_tpl->getVariable('message')->value=="activation_success"){?>   
